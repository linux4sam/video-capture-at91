...
media-ctl -d /dev/media0 --set-v4l2 "\"$(get_entity_name imx219)\":0[fmt:SRGGB10_1X10/1920x1080]"
...
media-ctl -d /dev/media0 --set-v4l2 "\"$(get_scaler_name)\":0[fmt:SRGGB10_1X10/1920x1080]"
